...
(async function() {
  ...
  const items = await Item.create([
    ...
    {name: 'Odor Eliminator Spray', image: 'https://i.imgur.com/b0RArV7.jpg', category: categories[1], price: 14.95},
    {name: 'Plastic Cleaner and Polish', image: 'https://i.imgur.com/fbVL3Be.jpg', category: categories[0], price: 1.95},
    {name: 'Premium Liquid Wax', image: 'https://i.imgur.com/XcvVuYa.jpg', category: categories[0], price: 16.95},
    {name: 'Quick Detailer', image: 'https://i.imgur.com/aKohAO4.jpg', category: categories[0], price: 12.95},
    {name: 'Scented Interior Wipes', image: 'https://i.imgur.com/x5s72eT.jpg', category: categories[1], price: 11.95},
    ...
    {name: 'Ultimate Polish', image: 'https://i.imgur.com/lYgcUQ7.jpg', category: categories[0], price: 28.95},
    ...
    {name: 'Water Magnet Drying Towels', image: 'https://i.imgur.com/g4Qgzur.jpg', category: categories[2], price: 8.95},
    {name: 'Water Magnet Drying Towels 3 Pack', image: 'https://i.imgur.com/5aYepBG.jpg', category: categories[4], price: 35.95},
